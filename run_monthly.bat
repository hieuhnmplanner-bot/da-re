...
echo [1/3] Sinh danh sach DEN HAN thang %M% (nguong toi da 20 buoi, co dedup)...
...
echo [3/4] Danh sach VAN HANH cho sale (nguong ^<=20, KHONG dedup)...
python "Script\monthly_expiry.py" %M% operational || goto err
python "Script\expiry_renewal_check.py" "Output\operational_%M%.csv" || goto err
echo [4/4] Nhom Ngu dong / Roi bo...
